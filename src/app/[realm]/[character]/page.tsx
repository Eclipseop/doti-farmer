...
const getMountData = async (
  ...
  const data = await fetch(
    `https://us.api.blizzard.com/profile/wow/character/${realm}/${character}/collections/mounts?namespace=profile-us&locale=en_US&access_token=${process.env.BLIZZARD_ACCESS_TOKEN}`
  );
